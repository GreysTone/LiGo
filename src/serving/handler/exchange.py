...
from serving.interface import exchange_pb2 as ex_pb2
from serving.interface import exchange_pb2_grpc as ex_pb2_grpc
...
class Exchange(ex_pb2_grpc.ExchangeServicer):
    def DownloadBin(self, request_iterator, context):
        for req in request_iterator:
            bin_path = os.path.join("/tmp", req.uuid)
